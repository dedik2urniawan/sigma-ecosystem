...
// ─── Login Page ─────────────────────────────────────────────────────────────
export default function MbgLoginPage() {
    ...
    return (
        <div className="flex min-h-screen bg-slate-50 font-display selection:bg-amber-100 selection:text-amber-900">
                    ...
                    <div className="max-w-xl">
                        ...
                        <div className="flex flex-wrap gap-3">
                            {[
                                ...
                                { icon: "restaurant", label: "Monev Gizi" },
                            ].map((f) => (
                                <div key={f.label} className="flex items-center gap-2 px-4 py-2 rounded-xl bg-white/5 border border-white/10 backdrop-blur-sm">
                                    <span className="material-icons-round text-amber-400 text-sm">{f.icon}</span>
                ...
                <div className={`w-full max-w-md relative z-10 transition-all duration-700 ${mounted ? "opacity-100 translate-y-0" : "opacity-0 translate-y-4"}`}>
                    ...
                    <div className="mb-10">
                        ...
                        <p className="text-slate-500 text-sm">
                            Masuk ke portal supervisi Dinkes untuk akses pemantauan program MBG.
                        </p>
                    </div>
                    ...
                    <form onSubmit={handleLogin} className="space-y-5">
                        ...
                        <div>
                            ...
                            <div className="relative group">
                                <div className="pointer-events-none absolute inset-y-0 left-0 flex items-center pl-4">
                                    <span className="material-icons-round text-slate-400 text-lg group-focus-within:text-amber-500 transition-colors">lock</span>
                                </div>
                                <input
                                    id="password"
                                    ...
                                    className="w-full pl-12 pr-12 py-4 rounded-xl bg-white border border-slate-200 text-slate-800 placeholder:text-slate-400 focus:outline-none focus:ring-2 focus:ring-amber-500/20 focus:border-amber-400 transition-all text-sm shadow-sm"
                                />
                                <button
                                    type="button"
                        ...
                        <button
                            ...
                            className="w-full py-4 px-6 rounded-xl bg-amber-600 text-white font-bold text-xs uppercase tracking-widest hover:bg-amber-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all shadow-lg shadow-amber-200 hover:shadow-amber-300 hover:-translate-y-0.5 flex items-center justify-center gap-3 group"
                        >
                            {isLoading ? (
                                <>
