...
interface IbuHamilFilterBarProps {
...
export default function IbuHamilFilterBar({
    mode,
    setMode,
    periodVal,
    setPeriodVal,
                ...
                <div className="flex flex-wrap items-center gap-2">
                    ...
                    {mode === "bulanan" ? (
                        <select
                            ...
                            className="text-xs font-semibold rounded-xl border border-slate-200 py-2 px-3 bg-white text-slate-800 focus:outline-none focus:ring-2 focus:ring-purple-500/20"
                        >
                            {[
                ...
                <div className="flex flex-wrap items-center gap-2">
                    <div className="relative">
                        <select
                            ...
                            className={`text-xs font-semibold rounded-xl border border-slate-200 py-2 px-3 text-slate-800 max-w-[210px] truncate focus:outline-none focus:ring-2 focus:ring-purple-500/20 ${
                    ...
                    <select
                        ...
                        className="text-xs font-semibold rounded-xl border border-slate-200 py-2 px-3 bg-white text-slate-800 max-w-[180px] truncate focus:outline-none focus:ring-2 focus:ring-purple-500/20"
                    >
