                    ...
                    <>
                        <ResponsiveContainer width="100%" height={350}>
                            <BarChart data={displayData} margin={{ top: 5, right: 30, left: 20, bottom: 60 }}>
                                ...
                                <Tooltip contentStyle={{ backgroundColor: 'white', border: '1px solid #e5e7eb', borderRadius: '8px', fontSize: 12 }} formatter={(value: any) => [typeof value === 'number' ? `${value.toFixed(1)} ml` : value, 'Rata-rata Dosis'] as any} />
